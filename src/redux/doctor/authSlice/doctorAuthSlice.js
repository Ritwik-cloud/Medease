...
export const fetchDoctorLogin = createAsyncThunk(
  "doctorAuthentication/fetchDoctorLogin",
  async (form_value) => {
...
export const fetchDoctorChangePassword = createAsyncThunk(
  "doctorAuthentication/fetchDoctorChangePassword",
  async () => {
...
export const fetchDoctorForgetPassword = createAsyncThunk(
  "doctorAuthentication/fetchDoctorForgetPassword",
  async () => {
...
export const fetchDoctorResetPassword = createAsyncThunk(
  "doctorAuthentication/fetchDoctorResetPassword",
  async () => {
...
let doctorProfile = endPoints.doctor.auth.profile;
console.log("doctor profile:", doctorProfile);

export const fetchDoctorProfile = createAsyncThunk(
  "doctorAuthentication/fetchDoctorProfile",
  async () => {
...
export const fetchDoctorLogout = createAsyncThunk(
  "doctorAuthentication/fetchDoctorLogout",
  async () => {
  ...
  extraReducers: (dev) => {
    dev
      ...
      .addCase(fetchDoctorProfile.fulfilled, (state, { payload }) => {
        if (payload.status === true) {
            toast.success(payload.message)
          state.doctorProfileDetails = payload.data
